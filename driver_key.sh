...
# QTLs generated when all ipscs were used (generated by nick banovich we think; Katie told me where the file was)
full_ipsc_qtl_data="/project2/gilad/katie/nbanovich_iPSC/iPSC_specific_eQTLs.txt"
...
for time_step in $(seq 0 15); do
    sbatch independent_time_step_eqtl_driver.sh $dosage_genotype_file $corrected_quantile_normalized_expression $gencode_gene_annotation_file $independent_time_step_eqtl_dir $distance $maf_cutoff $time_step $visualize_independent_time_step_eqtl_dir $full_ipsc_qtl_data $full_heart_eqtl_data
done
