...
output_file_prefix=$output_dir"eqtl_prepare_eqtl_distance_"$eqtl_distance"_maf_cutoff_"$maf_cutoff"_normalization_meth_"$normalization_method
...
for chrom_num in $(seq 1 22); do
    ...
    python prepare_independent_time_step_matrix_eqtl_files.py $time_step $chrom_num $dosage_genotype_file $quantile_normalized_expression $gencode_gene_annotation_file $output_root $maf_cutoff $normalization_method
    # Input file names
